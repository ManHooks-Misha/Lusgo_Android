...
import com.app.SyrianskaTaekwondo.hejtelge.widget.DayView;
import com.app.SyrianskaTaekwondo.hejtelge.widget.WeekView;
...
public class CollapsibleCalendarView extends LinearLayout implements View.OnClickListener, View.OnTouchListener {
    ...
    public CollapsibleCalendarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, 
                    R.styleable.CollapsibleCalendarView, 0, 0);
            try {
    ...
    public void populateLayout() {
        if (mManager != null) {
            ...
            String text=mManager.getHeaderText();
