...
public class VersionChecker extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        if (!versionname.equals(latestVersion) && (latestVersion != null)) {
            ...
            alert.setTitle("Uppdatering " + context.getResources().getString(R.string.app_name))
                    .setMessage("Ny version (" + s + ") tillgänglig. Snälla uppdatera.")
                    .setPositiveButton("Senare", (dialog, which) -> dialog.cancel())
                    .setNegativeButton("Uppdatering", (dialog, id) -> {
