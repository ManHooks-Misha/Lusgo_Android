...
public class Group_list_edit_Adapter extends RecyclerView.Adapter<Group_list_edit_Adapter.MyViewHolder> {
    String role, role_id;
    ...
    public Group_list_edit_Adapter(List<UserList> horizontalList,
    ...
    @NotNull
    @Override
    public Group_list_edit_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (userid.equals(horizontalList.get(position).getId())) {
    ...
    private void showCustomDialogTeam(int pos, String group_name) {
        ...
        builder.setPositiveButton("Ja", (dialogInterface, i) ->
                ...
                addTeamAPI(arr_user, groupid, pos, ""));
