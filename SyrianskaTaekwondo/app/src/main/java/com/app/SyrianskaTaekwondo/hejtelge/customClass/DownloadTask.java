        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setNegativeButton("Open Doc", (dialog, id) -> {
                        File pdfFile = new File(Environment.getExternalStorageDirectory() + "/Lusgo/" + downloadFileName);  // -> filename = maven.pdf
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "Lusgo");
                } else
