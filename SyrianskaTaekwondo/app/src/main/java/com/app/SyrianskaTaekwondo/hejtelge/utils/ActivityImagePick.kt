...
class ActivityImagePick :MasterActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(DATA)) {
            maxPick = intent.getIntExtra(DATA, 1)
        }
      ...
      //  setSupportActionBar(toolbar)
        ...
        ImagePicker.create(this).theme(R.style.AppTheme_No_).limit(maxPick).showCamera(true).start()
    }
