...
public class AdsTextView extends AppCompatTextView {
    ...
    public AdsTextView(Context context) {
        super(context);
        AdsTextView.context = context;
        textView = this;
        initViews();
    }

    public AdsTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        AdsTextView.context = context;
        textView = this;
        initViews();
    ...
    public AdsTextView(Context context, AttributeSet attrs, int defStyleAttr) {
