...
public class SentINBOX extends RecyclerView.Adapter {
...
// before loading more.
    ...
    public SentINBOX(ArrayList<InboxList> students, RecyclerView recyclerView, Activity context, String flag) {
